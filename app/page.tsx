              ...
              <div className="bg-slate-800 border border-gray-700 p-4 sm:p-6 rounded-xl space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-4 text-xs">
                  <div>
                    ...
                    <input type="text" value={stageHeroTitle} onChange={(e) => { setStageHeroTitle(e.target.value); setHasUnsavedChanges(true); }} className="w-full bg-slate-900 text-white border border-gray-600 rounded px-3 py-2.5 focus:border-amber-400 outline-none text-xs" />
                  </div>
                  <div>
                    <label className="block text-gray-400 font-bold mb-1">Staging Hero Background URL</label>
                    <input type="text" value={stageHeroBgUrl} onChange={(e) => { setStageHeroBgUrl(e.target.value); setHasUnsavedChanges(true); }} className="w-full bg-slate-900 text-white border border-gray-600 rounded px-3 py-2.5 focus:border-amber-400 outline-none text-xs" />
                  </div>
                  <div className="md:col-span-2">
                    <label className="block text-gray-400 font-bold mb-1">Staging Hero Paragraph Description Block</label>
                    <textarea value={stageHeroSub} onChange={(e) => { setStageHeroSub(e.target.value); setHasUnsavedChanges(true); }} rows={2} className="w-full bg-slate-900 text-white border border-gray-600 rounded px-3 py-2.5 focus:border-amber-400 outline-none text-xs" />
                  </div>
                </div>
              </div>
            )}
              ...
              <div className="bg-slate-800 border border-gray-700 p-4 sm:p-6 rounded-xl lg:col-span-2 space-y-6">
                ...
                {editingUser && (
                  <form onSubmit={saveUserEditToStage} className="bg-slate-900 p-4 rounded-lg border border-amber-500/30 grid sm:grid-cols-2 gap-4 text-xs text-gray-800">
                    ...
                    <button type="submit" className="sm:col-span-2 bg-amber-500 text-sky-950 font-bold py-2.5 rounded text-xs hover:bg-amber-600 transition border-none cursor-pointer">Save to Staging Cache</button>
                  </form>
                )}
                  ...
                  <form onSubmit={createMemberInStage} className="bg-slate-900/60 p-4 sm:p-5 rounded-xl border border-gray-700 space-y-4">
                    ...
                    <div className="grid sm:grid-cols-2 gap-4 text-xs text-gray-800">
                      ...
                      <div>
                        ...
                        <select value={newUser.role} onChange={(e) => setNewUser({...newUser, role: e.target.value})} className="w-full p-2 rounded border border-gray-300 bg-white text-xs focus:outline-none">
                          <option value="Member">Member</option>
                          <option value="Officer">Officer</option>
                          <option value="Super Admin">Super Admin</option>
                        </select>
                ...
                {userSession.role === 'Super Admin' ? (
                  <form onSubmit={(e) => e.preventDefault()} className="space-y-4 text-xs text-gray-800">
                    ...
                    <div>
                      ...
                      <select value={newActivity.type} onChange={(e) => setNewActivity({...newActivity, type: e.target.value})} className="w-full p-2 rounded border border-gray-300 bg-white focus:outline-none text-xs">
                    ...
                    <div>
                      ...
                      <input type="text" required value={newActivity.title} onChange={(e) => setNewActivity({...newActivity, title: e.target.value})} className="w-full p-2 rounded border border-gray-300 text-xs focus:outline-none" placeholder="Feeding Program 2026" />
                    </div>
                    <div>
                      <label className="block text-gray-400 font-bold mb-1">Strategic Objective Category</label>
                      <input type="text" required value={newActivity.category} onChange={(e) => setNewActivity({...newActivity, category: e.target.value})} className="w-full p-2 rounded border border-gray-300 text-xs focus:outline-none" placeholder="Supporting Education" />
                    </div>
                    <div>
                      <label className="block text-gray-400 font-bold mb-1">Public Summary Description Context</label>
                      <textarea required value={newActivity.description} onChange={(e) => setNewActivity({...newActivity, description: e.target.value})} rows={3} className="w-full p-2 rounded border border-gray-300 text-xs focus:outline-none" placeholder="Summarize field activities..." />
                    </div>
                    <div>
